    ...
    >
      ...
      <Popover.Button className="h-full ">
        ...
        >
          <Popover.Panel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 dark:text-white rounded-md dark:bg-dark-bg bg-white border-x border-b border-gray-200 w-[420px] text-ui-fg-base"
          >
            ...
            {cartState && cartState.items?.length ? (
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  ...
                  <span>{t("empty-shopping-cart")}.</span>
                  <div>
